...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_firstName'), 'Suman')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_lastName'), 'Kumar')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/h6_Suman Kumar'), 'Suman Kumar')
